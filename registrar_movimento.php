<?php
//aq dentro vavos codar em php
require_once('./conectorMySQL.php'); // esta linha carrega o arquivo /conectorMySQL.php

//para registrar o movimento da peça, temos que ter, mo minimo, três variaveis

/****
 * como declarar uma variavel e php:
 * prieiro digita-se o caractere cifrão "$", depois digita-se o nome da variavel, dai continua com o operador de atribuição " = ", e por fim o valor da variavel
 */
